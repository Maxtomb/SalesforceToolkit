...
public class QuartzManager {
  ...
  */
 public static void addJob(String jobName,Job job,String time, Map jobDataMap)
 ...
 public static void removeJob(String jobName,String jobGroupName,
	...
	public static List listAllJob() throws SchedulerException {
		Scheduler sched = sf.getScheduler();
		...
		for (String groupName : sched.getJobGroupNames()) {
			for (String jobName : sched.getJobNames(groupName)) {
				...
				jobList.add(groupName+","+jobName+","+nextFireTime);
			}
		}
		return jobList;
	}
